...
export interface Api {
  ...
  onScanCounters: (cb: (counters: { totalFound: number; totalAdded: number; totalSkipped: number; totalIncompatible: number; totalErrors: number; totalSkippedByFilter: number }) => void) => () => void
