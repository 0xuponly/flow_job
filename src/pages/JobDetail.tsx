      ...
      <div className="job-detail-grid">
        <div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 16 }}>
            <div className="card" style={{ flex: '1 0 140px', padding: '8px 12px', height: 90 }}>
            ...
            <div className="card" style={{ flex: '1 0 160px', padding: '8px 12px', height: 90 }}>
            ...
            <div className="card" style={{ flex: '1 0 120px', padding: '8px 12px', height: 90 }}>
            ...
            <div className="card" style={{ flex: '1 0 200px', padding: '8px 12px', height: 90 }}>
